...
class Rx_AM(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Receptor AM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Receptor AM")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Rx_AM")
        ...
        self.rtlsdr_source_0.set_sample_rate(1.92e6)
        self.rtlsdr_source_0.set_center_freq(106.9e6, 0)
        ...
        self.connect((self.blocks_complex_to_imag_0, 0), (self.blocks_selector_0, 1))
        self.connect((self.blocks_complex_to_mag_1, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_complex_to_real_0, 0), (self.blocks_selector_0, 0))
...
def main(top_block_cls=Rx_AM, options=None):
