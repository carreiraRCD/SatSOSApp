...
class proba_paq(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Proba paquetes", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Proba paquetes")
        ...
        self.settings = Qt.QSettings("GNU Radio", "proba_paq")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/carreira/GNURadio/enviar.dat', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/carreira/GNURadio/saida.dat', True)
...
def main(top_block_cls=proba_paq, options=None):
