...
class Tx_AM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Transmision AM", catch_exceptions=True)
        ...
        self.soapy_limesdr_sink_0.set_bandwidth(0, 1e6)
        self.soapy_limesdr_sink_0.set_frequency(0, 85e6)
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/media/sf_Universidad/6º ano/2 cuatrimestre/LPro/GNURadio/Archivos/C H I L L V I B E S ｜ Chill & aesthetic music playlist.wav', True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 15e3, 2e3, window.WIN_HAMMING, 6.76))
