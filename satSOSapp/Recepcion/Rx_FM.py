...
class Rx_FM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Rx_FM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Rx_FM")
        ...
        self._freq_range = Range(0, 200e6, 0.1, 145.5e6, 200)
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/carreira/GNURadio/saida.dat', False)
