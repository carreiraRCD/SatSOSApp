...
class Tx_FM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Tx_FM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Tx_FM")
        ...
        self.soapy_limesdr_sink_0.set_sample_rate(0, 1.92e6)
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/carreira/GNURadio/GNURadio/Archivos/C H I L L V I B E S Chill & aesthetic music playlist.wav', True)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(0.85)
